    ...
    <div className="relative">
      <button onClick={toggleDropdown}  className="flex items-center text-gray-700 dark:text-gray-400 dropdown-toggle" >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">          
          {
            photo ?
            <img className="max-w-full max-h-full w-auto h-auto rounded-xl object-contain" src={`${uriBase}/${photo}`} alt="foto de perfil"/>
            :
            <span className="relative flex items-center justify-center text-2xl font-semibold text-gray-500 transition-colors bg-white border border-gray-200 rounded-full hover:text-gray-700 h-11 w-11 hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white">
              {photoName}
            </span>
          }
        </span>
